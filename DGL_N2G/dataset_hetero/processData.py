...
def processData():
    localPaths = [
        'MUTAG/MUTAG_A.txt', 'MUTAG/MUTAG_graph_indicator.txt',
        'MUTAG/MUTAG_node_labels.txt', 'MUTAG/MUTAG_graph_labels.txt',
    ...
    with open(globalPath[0], 'r') as edgeRelFile, \
        ...
        edgeDict = createEdgeDict(ntypeDict, etypeKey, edgeTypeFile,
                                  edgeRelFile)
        ...
        nodeLabels = createNodeLabelsDict(graphLabels, graphIndicator,
                                          ntypeDict)
...
def createEdgeDict(ntypeDict, etypeKey, edgeTypeFile, edgeRelFile):
    ...
    for edgeType, edgeRel in zip(edgeTypeFile, edgeRelFile):
        ...
        etypeRel = (ntypeDict[edgeRel[0]], etypeKey[edgeType],
                    ntypeDict[edgeRel[1]])
